...
for i in range(cfg.N_REPETITIONS):
    ...
    signal_sizes = [40*window_length]*16 + [5*window_length]*16 #in this case the signal size is the same for all channels, but the model aloows different sizes
    sampling_rates = [40]*16 + [5]*16 #in this case the sampling rate is the same for all channels, but the model aloows different sizes
